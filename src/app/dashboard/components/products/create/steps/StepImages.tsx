 ...
 * @description Paso 2: Imágenes del producto - VERSIÓN SIMPLIFICADA
 */
...
interface StepImagesProps {
  gallery?: ProductImage[];  // ← MISMO TIPO
  onImagesChange: (images: ProductImage[]) => void;  // ← MISMO TIPO
  completed?: boolean;
}
  ...
  return (
    ...
    >
      <Card variant="elevated" hoverEffect="organic" className="p-4 sm:p-6">
        ...
        {/* Uploader - TODO DIRECTO, MISMO TIPO */}
        <div className="space-y-2">
          ...
          <ImageUploader
            value={gallery}           // ← ProductImage[] directamente
            onChange={onImagesChange}  // ← Recibe ProductImage[] directamente
            maxFiles={5}
            maxSize={10}
            showMainBadge={true}
