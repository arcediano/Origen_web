 ...
 * @description Paso 6: Inventario y gestión de stock - VERSIÓN ACTUALIZADA
 */
...
export function StepInventory({ 
  ...
  const handleGenerateSkuClick = async () => {
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <Tooltip 
                ...
                detailed="El SKU (Stock Keeping Unit) es un código único para tu inventario interno. Formato recomendado: CAT-001"
                size="sm"
              />
            </div>
            <div className="flex gap-2">
              <div className="relative flex-1">
                <Input
                  ...
                  className={cn(
                    "h-12 font-mono text-base w-full rounded-xl pr-20",
              ...
              <button
                ...
                className="h-12 px-4 rounded-xl border-2 border-origen-pradera/30 hover:border-origen-pradera hover:bg-origen-pradera/5 transition-all flex items-center gap-2 text-sm font-medium text-origen-bosque bg-white shrink-0"
              >
                {isGeneratingSku ? (
