 ...
 * @description Paso 4: Información nutricional - VERSIÓN ACTUALIZADA
 */
...
export interface NutritionalInfo {
  ...
  vitamins: Array<{ id: string; name: string; amount: number; unit: string; dailyValue: number }>;
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => handleChange('servingSizeUnit', v)}
                    >
                  ...
                  <div className="space-y-2 max-h-80 overflow-y-auto pr-2 border border-gray-200 rounded-xl p-3">
                    {ALLERGENS.map(allergen => {
                      ...
                      return (
                        <label key={allergen} className="flex items-center gap-3 p-2 hover:bg-origen-crema/30 rounded-lg cursor-pointer">
                          <Checkbox
                            checked={nutritionalInfo.mayContain.includes(allergen)}
                            onCheckedChange={(checked) => {
                              const updated = checked
                                ? [...nutritionalInfo.mayContain, allergen]
                                : nutritionalInfo.mayContain.filter((a: string) => a !== allergen);
