 ...
 * @description Paso 5: Historia y producción - VERSIÓN ACTUALIZADA
 */
...
const ProductionSchema = z.object({
  ...
  origin: z.string().min(2, 'El origen es requerido').optional(),
});
...
export function StepProduction({ 
  ...
  const handleMediaChange = (files: ImageFile[]) => {
          ...
          {activeTab === 'media' && (
            ...
            >
              <div className="space-y-2">
                ...
                <ImageUploader
                  value={mediaItems.filter(m => m.type === 'image')}
