    ...
    <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-b from-white to-origen-crema">
          ...
          <defs>
            <pattern id="leaf-small" width="60" height="60" patternUnits="userSpaceOnUse">
              <path d="M30,10 Q40,15 35,25 Q30,35 20,30 Q10,25 15,15 Q20,5 30,10 Z" 
                    fill="none" stroke="#06D6A0" strokeWidth="0.5"/>
            </pattern>
          </defs>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 bg-origen-menta/10 text-origen-bosque rounded-full px-4 py-2 md:px-6 md:py-3 mb-4 md:mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-origen-bosque mb-4 md:mb-6">
            ...
            <span className="block text-origen-menta">inspiran</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="group relative">
              ...
              <div className="relative bg-white rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-lg md:shadow-xl border border-gray-200 group-hover:border-origen-menta transition-all">
                ...
                <div className="flex items-center gap-3 md:gap-4 pt-4 md:pt-6 border-t border-gray-100">
                  <div className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-origen-menta to-origen-pradera rounded-xl md:rounded-2xl flex items-center justify-center text-white text-lg md:text-xl lg:text-2xl font-bold shadow-md md:shadow-lg flex-shrink-0">
                    {testimonial.name.charAt(0)}
                  </div>
                  <div className="min-w-0">
                    <h4 className="font-bold text-origen-bosque text-base md:text-lg lg:text-xl truncate">{testimonial.name}</h4>
                    <p className="text-gray-600 text-sm md:text-base truncate">{testimonial.business}</p>
                    <p className="text-xs md:text-sm text-origen-menta font-semibold mt-1 truncate">{testimonial.category}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center mt-12 md:mt-16 pt-8 md:pt-12 border-t border-gray-200">
          <div className="inline-flex items-center gap-3 md:gap-4 bg-white rounded-xl md:rounded-2xl px-6 py-3 md:px-8 md:py-4 shadow-lg border border-gray-200">
            <ShieldCheck className="w-6 h-6 md:w-8 md:h-8 text-origen-menta" />
