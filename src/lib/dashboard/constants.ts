...
export const DASHBOARD_MENU = [
  ...
  },
  {
    ...
    submenu: [
      { id: 'todos-productos', label: 'Todos los productos', href: '/dashboard/productos' },
      { id: 'nuevo-producto', label: 'Añadir producto', href: '/dashboard/productos/nuevo' },
      { id: 'categorias', label: 'Categorías', href: '/dashboard/productos/categorias' },
      { id: 'inventario', label: 'Inventario', href: '/dashboard/productos/inventario' }
    ]
  },
  {
    id: 'pedidos',
